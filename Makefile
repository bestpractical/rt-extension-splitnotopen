# This Makefile is for the RT::Extension::SplitNotOpen extension to perl.
#
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = RT::Extension::SplitNotOpen
NAME_SYM = RT_Extension_SplitNotOpen
VERSION = 0.05
...
MAKE = make
FULLEXT = RT/Extension/SplitNotOpen
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/RT/Extension/SplitNotOpen.pm \
	lib/RT/Interface/Email/Filter/SplitNotOpen.pm
...
TO_INST_PM = lib/RT/Extension/SplitNotOpen.pm \
	lib/RT/Interface/Email/Filter/SplitNotOpen.pm

PM_TO_BLIB = lib/RT/Interface/Email/Filter/SplitNotOpen.pm \
	blib/lib/RT/Interface/Email/Filter/SplitNotOpen.pm \
	lib/RT/Extension/SplitNotOpen.pm \
	blib/lib/RT/Extension/SplitNotOpen.pm
...
DISTNAME = RT-Extension-SplitNotOpen
DISTVNAME = RT-Extension-SplitNotOpen-0.05
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/RT/Interface/Email/Filter/SplitNotOpen.pm $(INST_MAN3DIR)/RT::Interface::Email::Filter::SplitNotOpen.$(MAN3EXT) \
	  lib/RT/Extension/SplitNotOpen.pm $(INST_MAN3DIR)/RT::Extension::SplitNotOpen.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/RT/Interface/Email/Filter/SplitNotOpen.pm blib/lib/RT/Interface/Email/Filter/SplitNotOpen.pm \
	  lib/RT/Extension/SplitNotOpen.pm blib/lib/RT/Extension/SplitNotOpen.pm 
